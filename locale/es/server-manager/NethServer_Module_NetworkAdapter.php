...
$L['interface-config_label'] = 'Configuracion de Interface';
$L['valid_platform,interface-config,interface-role,3'] = "DHCP solo se puede utilizar en las interfaces rojas";
$L['valid_platform,interface-config,interface-role,4'] = "No se puede eliminar la ultima interface verde";
$L['No'] = 'No';
$L['Yes'] = 'Si';
...
$L['SetIpAddress_header'] = 'Configurar asignacion de IP - ${0}';
...
$L['Edit_description'] = "Status del link es  \${link}\nSpeed \${speed} Mbit/s\nDriver \${driver}\nMac address \${mac}";
$L['Link_status_up'] = 'Levantada';
$L['Link_status_down'] = 'Baja';
