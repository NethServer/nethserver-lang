...
$L['Commit_label'] = 'Speicher Änderungen';
$L['Edit_label'] = 'ändern';
...
$L['HostGroups_create'] = 'erstelle host Gruppe "${0}"';
$L['Hosts_create'] = 'erstelle host "${0}"';
$L['Zones_create'] = 'erstelle Zone "${0}"';
$L['Services_create'] = 'erstelle service "${0}"';
$L['IpRange_create'] = 'erstelle IP Bereich "${0}"';
$L['Cidr_create'] = 'erstelle CIDR Netzwerk "${0}"';

$L['A_new_rule_label'] = "Neue Regel";
$L['Any_label'] = 'alle';
$L['NoRulesDefined_label'] = 'keine Regel definiert. Erstellen Sie jetzt die erste!';

$L['any_service_label'] = 'alle service';
$L['any_src_dst_label'] = 'alle host';
$L['all_label'] = 'alle';
$L['host_label'] = 'host';
$L['zone_label'] = 'Zone';
...
$L['confirm_reload_label'] = 'keine Änderungen gespeichert.';
