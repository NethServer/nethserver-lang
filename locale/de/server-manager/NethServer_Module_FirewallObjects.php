...
$L['HostGroups_Title'] = 'Host Gruppe';
...
$L['Service_key_exists_message'] = 'Servicename ist bereits in Benutzung';
$L['Services_CreateService_label'] = 'Dienst erstellen';
$L['Services_update_label'] = 'ändere service "${0}"';
...
$L['valid_platform,fwobject-zone-delete,fwobject-referenced,3'] = 'Kann nicht gelöscht werden: ${2}. Die Zone ist in Benutzung durch die Firewall.';
$L['valid_platform,fwobject-fwservice-delete,fwobject-referenced,3'] = 'Kann nicht gelöscht werden: ${2}. Der Service ist in Benutzung durch die Firewallregeln.';
...
$L['valid_platform,fwobject-cidr-delete,fwobject-referenced,3'] = 'Konnte ${2} nicht löschen. Der CIDR wird von den Firewall-Regeln benutzt.';
...
$L['valid_platform,fwobject-host-delete,fwobject-hostgroup-remove-member,3'] = 'Konnte ${2} nicht löschen: Es ist das letzte Member der Host-Gruppe ${${reason}}.';
