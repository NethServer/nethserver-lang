...
$L['Access_label'] = 'Τοπικό δίκτυο μόνο';
$L['Account_label'] = 'Destinations';
$L['Pseudonym_create_header'] = 'Create a new mail alias';
$L['Current_label'] = 'Τρέχουσα επιλογή'; 
$L['Description_label'] = 'Περιγραφή'; 
$L['Pseudonym_update_header'] = 'Edit mail alias `${0}`';
$L['Flag_label'] = 'Χαρακτηριστικά'; 
$L['Groups_label'] = 'Ομάδες'; 
$L['Key_label'] = 'Ψευδώνυμο';
$L['Users_label'] = 'Χρήστες'; 
$L['domainAddress_label'] = 'Domain'; 
$L['localAddress_label'] = 'Διεύθυνση email'; 
$L['pseudonym_label'] = 'Διεύθυνση email';
$L['valid_pseudonym_unique'] = 'Αυτή η διεύθυνση υπάρχει ήδη';
