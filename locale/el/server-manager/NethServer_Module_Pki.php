...
$L['Pki_Title'] = 'Πιστοποιητικό διακομιστή';
$L['Pki_Description'] = 'Manage TLS/SSL server certificates';
$L['Pki_Tags'] = 'SSL certificate PKI TLS X509 X.509';

$L['C_label'] = 'Κωδικός χώρας';
$L['ST_label'] = 'Κατάσταση';
$L['L_label'] = 'Τοπικότητα';
$L['O_label'] = 'Οργανισμός';
$L['OU_label'] = 'Οργανωτική μονάδα';
$L['CN_label'] = 'Σύνηθες όνομα';
$L['EmailAddress_label'] = 'Διεύθυνση email';
$L['SubjectAltName_label'] = 'Εναλλακτικά ονόματα';
$L['CertificateDuration_label'] = 'Ισχύς πιστοποιητικού (σε μέρες)';
$L['valid_hostname_instance'] = 'Το όνομα φορέα "${0}" είναι λάθος ';
$L['valid_x509_field'] = 'Πρέπει να περιέχει "," (κόμμα) και "/" (κάθετος)';
