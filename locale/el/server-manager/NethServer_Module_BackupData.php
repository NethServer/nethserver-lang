...
$L['notifyFrom_label'] = 'Διεύθυνση Αποστολέα';
...
$L['invalid_pipe_char'] = 'Το πεδίο δεν μπορεί να περιέχει το χαρακτήρα "|"';
$L['invalid_last_char'] = 'Ο τελευταίος χαρακτήρας δεν μπορεί να είναι ανάποδη κάθετος  "\\"';
$L['invalid_url'] = 'Invalid URL';
$L['webdav_label'] = 'WebDAV';
$L['WebDAVUrl_label'] = 'Διακομιστής';
$L['WebDAVLogin_label'] = '¨Ονομα χρήστη';
$L['WebDAVPassword_label'] = 'Κωδικός';
