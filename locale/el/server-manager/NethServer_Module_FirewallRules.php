...
$L['Create_header'] = 'Δημιουργία νέου κανόνα του τείχους προστασίας';
...
$L['HostGroups_create'] = 'Δημιουργία νέας ομάδας φορέων "${0}"';
$L['Hosts_create'] = 'Δημιουργία νέου φορέα "${0}"';
$L['Zones_create'] = 'Δημιουργία νέας ζώνης"${0}"';
$L['Services_create'] = 'Δημιουργία νέας υπηρεσίας "${0}"';
