...
$L['valid_hostname_fqdn_long'] = 'nome host con il dominio composto almeno da ${0} parti';
$L['valid_hostname_fqdn_exact'] = 'nome host con il dominio composto almeno da ${0} parti e al massimo da ${1}';
