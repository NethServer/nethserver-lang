...
$L['Action_create_bridge'] = 'Criar uma nova ponte ${device} com ${parts}';
$L['Action_create_bond'] = 'Criar um novo vinculo ${device} com ${parts}';
$L['Action_create_vlan'] = 'Criar uma nova VLAN ${device} em ${parts}';
...
$L['slave_label'] = 'Escravo';
$L['CreateIpAlias_header'] = 'Criar nome IP "${0}"';
...
$L['DeleteLogicalInterface_bond_message'] = "A apagar vinculo \${device}.\nEscolha um sucessor dos interfaces escravos para configurá-lo com as funções e definições de IP actuais";
...
$L['MAC: ${0}'] = 'MAC ${0}';
$L['Model: ${0}'] = 'Modelo ${0}';
$L['All roles are correctly assigned to network cards.'] = 'Todas as funções estão correctamente atribuídas às placas derede';