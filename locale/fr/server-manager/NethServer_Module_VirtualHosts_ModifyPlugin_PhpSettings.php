...
$L['Maximum upload file size (${0})'] = 'Taille maximum du fichier téléchargé (${0})';
...
$L['PhpPostMaxSize_label'] = 'Erreur de limite de téléversement';
$L['default_php_warning_label'] = 'Apache doit être le gestionnaire de PHP si vous voulez modifier les valeurs ici, sinon utilisez le panneau Paramètres php';
