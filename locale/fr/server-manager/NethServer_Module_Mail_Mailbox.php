...
$L['Quota default size ${0}'] = 'Taille par défaut ${0}'; 
$L['QuotaStatus_disabled_label'] = 'Illimité'; 
$L['QuotaStatus_enabled_label'] = 'Appliquer les quotas'; 
$L['Spam messages handling'] = 'Traitement des spams'; 
$L['SpamFolder_label'] = 'Déplacer dans le dossier indésirable';
$L['TlsSecurity_label'] = 'Autoriser les connexions non chiffrées';
$L['Privileged access'] = 'Accès privilégié';
$L['AdminIsMaster_label'] = 'Root peut se connecter en tant qu\'un autre utilisateur';
$L['ever'] = 'toujours'; 
