<?php
$L['PhpDefault_Title'] = 'Versão padrão do Php';
$L['PhpDefaultAdjustableValues_Title'] = 'Gerenciar as Configurações Php Padrão';
$L['PhpAdjustableValues_Title'] = 'Configorações Php';
