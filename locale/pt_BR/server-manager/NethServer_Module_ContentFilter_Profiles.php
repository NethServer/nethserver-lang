...
$L['When_rules_label'] = 'Um tempo especifico ';
...
$L['FilterElse_label'] = 'Caso contrário aplique o seguinte filtro';
$L['FilterColumnWithElse_label'] = '${0}, de outra forma ${1}';
