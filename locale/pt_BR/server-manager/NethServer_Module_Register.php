...
$L['Authenticate_header'] = '(${0}) Authentication required';
$L['Authenticate_description'] = 'Provide credentials to Operation Center';
...
$L['CustomerCity_label'] = 'City';
$L['CustomerEmail_label'] = 'Email';
$L['CustomerPhone_label'] = 'Telephone';

$L['ServerId_label'] = 'Server Identifier';
$L['ServerIdType_existing_label'] = 'Use existing Server Identifier';
$L['ServerIdType_new_label'] = 'Create new Server Identifier';
$L['MachineName_label'] = 'Machine name';
$L['MachineDescription_label'] = 'Machine description';

$L['Invalid_credentials_label'] = 'Invalid credentials';
...
$L['Server_Registration_Failure'] = 'Registration failed';

$L['Next_label'] = 'Next';
$L['Back_label'] = 'Back';

$L['Tracker_header'] = 'Updating software';
$L['Please_wait_label'] = 'Please wait';
$L['package_success'] = 'System is up-to-date';

$L['Installer_Generic_Failure'] = "An error occured during system update. See logs for more details.";
