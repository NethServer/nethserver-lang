...
$L['Create a new domain'] = 'Criar um novo domínio';
$L['Delete_label'] = 'Apagar';
$L['DisclaimerStatus_label'] = 'Adicionar uma nota jurídica as mensagens enviadas';
...
$L['Update domain `${0}`'] = 'Atualizar domínio `${0}`'; 
$L['domain_label'] = 'Domínio';
$L['valid_relay_notprimarydomain'] = 'O domínio da caixa de correio local não pode ser retransmitido';
