...
$L['Fail2BanUnban_Title'] = 'Zwarte lijste';
...
$L['status_label'] = 'Schakel de service in';
$L['Maximum find time (${0})'] = 'Maximale zoektijd (${0})';
$L['${0} week'] = '${0} week';
$L['${0} weeks'] = '${0} weken';
$L['${0} days'] = '${0} dagen';
$L['${0} day'] = '${0} dag';
...
$L['Maximum ban time (${0})'] = 'Maximale blokkadetijd (${0})';
$L['Maximum retry number (${0})'] = 'Maximum aantal pogingen (${0})';
...
$L['CustomDestemail_label'] = 'Email beheerders (een per regel)';
$L['LogLevel_label'] = 'Logging niveau';
$L['JailsStatus_label'] = 'Status van Jails';
