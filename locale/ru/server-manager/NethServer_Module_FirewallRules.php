...
$L['valid_platform,fwrule-modify,fwrule-ndpi,4'] = 'Правила, использующие DPI-протокол в качестве службы, не позволяют указывать "Firewall" в качестве источника или назначения.';
