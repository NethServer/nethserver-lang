...
$L['LogType_label'] = 'Записать в лог при соответствии этому правилу';
...
$L['valid_platform,fwrule-modify,fwrule-route2provider,5'] = 'Правила маршрутизации не позволяют указывать DPI-протокол в качестве Службы.';
