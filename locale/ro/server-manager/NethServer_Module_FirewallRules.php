...
$L['Destination_label'] = 'Destinatie';
$L['Service_label'] = 'Serviciu';
$L['Time_label'] = 'Condiție temporală';
...
$L['PickObject_TimeRaw_header'] = 'Alege condiția temporală pentru regula "${RuleId}"';

$L['Create_last_label'] = 'Crează o regulă în coadă';
$L['Create_first_label'] = 'Crează o regulă la inceput';
...
$L['Time_create'] = 'Crează condiția temporală "${0}"';
$L['IpRange_create'] = 'Crează interval IP "${0}"';
$L['Cidr_create'] = 'Crează rețea CIDR "${0}"';

$L['A_new_rule_label'] = "Regulă nouă";
$L['NoRulesDefined_label'] = 'Nu există nici o regulă definită. Creaz-o acum pe prima acum!';
...
$L['FirewallObject_time_Title'] = '${key} - condiție temporală';
...
$L['ShowRoutes_label'] = 'Rutare politică';
...
$L['valid_platform,fwrule-modify,fwrule-trafficshaping,3'] = 'Regulile de modelare a traficului nu permit zonei roșii să fie setată drept sursă';
$L['valid_platform,fwrule-modify,fwrule-trafficshaping,4'] = 'Regulile de modelare a traficului permit numai următoarele tipuri de destinații: zonă, gazdă, interval IP, CIDR, roșu.';