...
$L['Review_Description'] = 'Примени измене да осигурате подешавање сервера';
$L['Changes_label'] = 'Примени следеће измене:';

$L['redirect_message'] = 'Настави са страницом за подешавање мрежних интерфејса, након што измене буду примењене.';
