...
$L['AccountProvider_Error_49'] = 'Chyba poskytovatele účtů: neplatné přihlašovací údaje (${0})';
...
$L['AccountProvider_Error_4'] = 'Varování poskytovatele účtů: překročen limit velikosti (${0})';
