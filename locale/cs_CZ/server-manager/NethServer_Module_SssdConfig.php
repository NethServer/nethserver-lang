...
$L['bindAdSuccess_notification'] = 'Úspěšně připojeno do domény Active Directory ${0}';
...
$L['valid_platform,dcrealm,differhostname,3'] = 'Je třeba, aby nebylo stejné, jako FQDN název stroje';
